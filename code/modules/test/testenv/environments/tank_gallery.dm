...
/datum/test_environment/tank_gallery/populate(char, char_turf)
	...
	switch(char)
		if("a", "b", "i", "j")
			...
			turret.add_hardpoint(new /obj/item/hardpoint/secondary/m56t)
		if("c", "d", "k", "l")
			tank.add_hardpoint(new /obj/item/hardpoint/support/overdrive_enhancer)
			turret.add_hardpoint(new /obj/item/hardpoint/primary/flamer)
			turret.add_hardpoint(new /obj/item/hardpoint/secondary/flamer)
		if("e", "f", "m", "n")
			tank.add_hardpoint(new /obj/item/hardpoint/support/advanced_optics)
			turret.add_hardpoint(new /obj/item/hardpoint/primary/ltb)
			turret.add_hardpoint(new /obj/item/hardpoint/secondary/grenade_launcher)
		if("g", "h", "o", "p")
			tank.add_hardpoint(new /obj/item/hardpoint/support/weapons_boost)
			turret.add_hardpoint(new /obj/item/hardpoint/primary/minigun)
			turret.add_hardpoint(new /obj/item/hardpoint/secondary/tow)
